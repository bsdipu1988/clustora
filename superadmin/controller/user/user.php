...
class ControllerUserUser extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$mobileNumber=$this->request->post['phone'];
			//$email=$_REQUEST["email"];
			$username=$this->request->post['username'];
			$password=$this->request->post['password'];//echo $username . $password .$mobileNumber;
			$message="Welcome to Clustora Family.Your USERNAME=".$username." and PASSWORD=".$password." .Start managing your store by clicking seller account in the clustora.com";
			$senderId="CLUSTO";
			$routeId="1";
	...
	protected function validateForm() {
		...
		if ((utf8_strlen(trim($this->request->post['phone'])) != 10) ) {
