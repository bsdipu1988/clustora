...
class ControllerCommonMenu extends Controller {
	public function index() {
		...
		$data['category'] = $this->url->link('catalog/category&token=' . $this->session->data['token']. '&uid=' . $this->session->data['user_id'], 'SSL');
		...
		$data['product'] = $this->url->link('catalog/product&token=' . $this->session->data['token']. '&uid=' . $this->session->data['user_id'], 'SSL');
		...
		$data['return'] = $this->url->link('sale/return&token=' . $this->session->data['token']. '&uid=' . $this->session->data['user_id'], 'SSL');
